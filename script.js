...
// Lagnamn
const teams = ["Lag Lost and Found", "Lag Colorama", "Lag Discotek", "Lag Tomtenissarna", "Lag Beachboys"];

const matches = [
    { id: "1",  team1: "Lag Lost and Found", team2: "Lag Colorama",       score: "" }, 
    { id: "2",  team1: "Lag Discotek",       team2: "Lag Tomtenissarna", score: "" }, 
    { id: "3",  team1: "Lag Beachboys",      team2: "Lag Lost and Found", score: "" }, 
    { id: "4",  team1: "Lag Colorama",       team2: "Lag Discotek",      score: "" }, 
    { id: "5",  team1: "Lag Tomtenissarna",  team2: "Lag Beachboys",     score: "" }, 
    { id: "6",  team1: "Lag Lost and Found", team2: "Lag Tomtenissarna", score: "" }, 
    { id: "7",  team1: "Lag Colorama",       team2: "Lag Beachboys",     score: "" }, 
    { id: "8",  team1: "Lag Discotek",       team2: "Lag Beachboys",     score: "" }, 
    { id: "9",  team1: "Lag Colorama",       team2: "Lag Tomtenissarna", score: "" }, 
    { id: "10", team1: "Lag Lost and Found", team2: "Lag Discotek",      score: "" }, 
];
...
function renderStandings() {
    ...
    standings
        .sort((a, b) =>
    b.points - a.points ||
    (b.goalsFor - b.goalsAgainst) - (a.goalsFor - a.goalsAgainst)) // Sortera efter poäng
        .forEach(stat => {
...
function updateStandings(team1, team2, score1, score2) {
    ...
    // Uppdatera mål framåt och bakåt
